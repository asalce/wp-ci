...
wp_enqueue_script('jquery-ui', WP_PLUGIN_URL.'/wp-ci/ci/system/helpers/jquery_ui/js/jquery-ui-1.7.2.custom.min.js', array('jquery'));
wp_register_style('jquery-ui', WP_PLUGIN_URL.'/wp-ci/ci/system/helpers/jquery_ui/css/smoothness/jquery-ui-1.7.2.custom.css');
